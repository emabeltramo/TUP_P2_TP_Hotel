...
namespace HotelForm.View.Factura
{
    public partial class frmNuevaFactura : Form
    {
        ...
        {
            cboCliente.DataSource = await clienteService.GetClientesAsync();
            cboCliente.DisplayMember = "NombreCompleto";
            cboCliente.ValueMember = "Id_Cliente";

            cboTipoFactura.DataSource = await clienteService.GetTipoFacturaAsync();
            cboTipoFactura.DisplayMember = "Tipo";
            cboTipoFactura.ValueMember = "Id";

            cboFormaPago.DataSource = await clienteService.GetFormaPagoAsync();
            cboFormaPago.DisplayMember = "Descripcion";
            cboFormaPago.ValueMember = "Id";

            cboServicio.DataSource = await clienteService.GetTipoServicioAsync();
